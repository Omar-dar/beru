...
def voice_chat():
    ...
    if memory.is_omar():
        greeting = "Tjena Omar! Vad händer kompis?"
    elif memory.is_known_user():
        name = memory.get_user_name()
        greeting = f"Welcome back {name}! How can I help you?"
    else:
        greeting = "Hello! I am Tild. Who am I talking to?"
